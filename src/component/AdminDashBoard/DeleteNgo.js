...
export default function DeleteNgo() {
  ...
  const  updateUser=async()=>{
    axios
    .delete("http://localhost:9006/api/AdminUser/v1/deleteNgoUser/"+updatebeneficiary.ngoId)
    .then((response) => {
      if (response.status === 200) {
        window.alert("You have Successfully Deleted NGO")
    ...
    return (
      sessionStorage.getItem("adminId")!==null ? (
        ...
        >
          ...
          <h4 style={{"color":"black"}}className="text-center container my-2 pt-5">Delete Ngo User</h4>
            ...
            <div id="login-box" className="col-md-12">
              ...
              <div className="form-row  ">
                ...
                <div className="form-group ">
                  <label Htmlfor="benid">Ngo-ID</label>
                  <input
                    onChange={(e) =>
                    ...
                    id="ngoId"
                    placeholder="Write ngoId Whom you want to delete"
                    required
                  />
                </div>
