...
export default function DeleteDonor() {
  ...
  const  updateUser=async()=>{
    axios
    .delete("http://localhost:9006/api/AdminUser/v1/deleteDonorUser/"+updatebeneficiary.donorID)
    .then((response) => {
      if (response.status === 200) {
        window.alert("You have Successfully Deleted Donor")
    ...
    return (
      sessionStorage.getItem("adminId")!==null ? (
        ...
        >
          ...
          <h4 style={{"color":"black"}}className="text-center container my-2 pt-5">Delete Donor User</h4>
            ...
            <div id="login-box" className="col-md-12">
              ...
              <div className="form-row  ">
                ...
                <div className="form-group ">
                  <label Htmlfor="benid">Donor-ID</label>
                  <input
                    onChange={(e) =>
                    ...
                    id="donorID"
                    placeholder="Write DonorID Whom you want to delete"
                    required
                  />
                </div>
