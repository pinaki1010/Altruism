      ...
      <div className="news-slider__wrp swiper-wrapper">
        ...
        <div className="news-slider__item swiper-slide">
          <a href="#" className="news__item">
            ...
            <div className="news__img">
              <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt="news" />
            </div>
          </a>
        </div>
        <div className="news-slider__item swiper-slide">
          <a href="#" className="news__item">
            ...
            <div className="news__img">
              <img src="https://images.unsplash.com/photo-1429667947446-3c93a979b7e0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="news" />
            </div>
          </a>
        </div>
        <div className="news-slider__item swiper-slide">
          <a href="#" className="news__item">
            ...
            <div className="news__img">
              <img src="https://images.unsplash.com/photo-1435575653489-b0873ec954e2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt="news" />
            </div>
          </a>
        </div>
        <div className="news-slider__item swiper-slide">
          <a href="#" className="news__item">
            ...
            <div className="news__img">
              <img src="https://images.unsplash.com/photo-1471039497385-b6d6ba609f9c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt="news" />
            </div>
          </a>
        </div>
        <div className="news-slider__item swiper-slide">
          <a href="#" className="news__item">
            ...
            <div className="news__img">
              <img src="https://images.unsplash.com/photo-1453284441168-8780c9f52097?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt="news" />
            </div>
          </a>
        </div>
      </div>
        ...
        <div className="news-slider__arrows">
          <button className="news-slider__arrow news-slider-prev">
            <span className="icon-font">
              <svg className="icon icon-arrow-left"><use xlinkHref="#icon-arrow-left" /></svg>
            </span>
          </button>
